...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	CSize size1(MulDiv(rect.Width(), 25, 100), ::GetSystemMetrics(SM_CYSCREEN)); // 폭(25%)
	CSize size2(MulDiv(rect.Width(), 75, 100), ::GetSystemMetrics(SM_CYSCREEN)); // 폭(75%)
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(MyForm), size1, pContext)) {
	...
	m_pMainView = (CMapToolView*)RUNTIME_CLASS(CMapToolView);
	m_pMyForm = (MyForm*)RUNTIME_CLASS(MyForm);
