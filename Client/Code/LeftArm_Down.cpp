...
CLeftArm_Down::CLeftArm_Down(LPDIRECT3DDEVICE9 pDevice)
: CCubeObject(pDevice)
{
}

CLeftArm_Down::CLeftArm_Down(LPDIRECT3DDEVICE9 pDevice, UNITTYPE eUnitType)
: CCubeObject(pDevice)
...
CLeftArm_Down::~CLeftArm_Down(void)
{
	Release();
}

HRESULT CLeftArm_Down::Invalidate(void)
{
...
HRESULT CLeftArm_Down::AddComponent(void)
{
...
void CLeftArm_Down::Update(void)
{
...
void CLeftArm_Down::Render(void)
{
	CCubeObject::Render();
...
void CLeftArm_Down::Release(void)
{

}

CLeftArm_Down* CLeftArm_Down::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CLeftArm_Down* pLeftArm_Down = new CLeftArm_Down(pDevice);

	if(FAILED(pLeftArm_Down->Invalidate()))
		ENGINE::Safe_Delete(pLeftArm_Down);

	return pLeftArm_Down;
}

CLeftArm_Down* CLeftArm_Down::Create(LPDIRECT3DDEVICE9 pDevice, UNITTYPE m_eUnitType)
{
	CLeftArm_Down* pLeftArm_Down = new CLeftArm_Down(pDevice, m_eUnitType);
