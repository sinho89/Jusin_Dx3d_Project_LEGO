...
CRightLeg::CRightLeg(LPDIRECT3DDEVICE9 pDevice)
: CCubeObject(pDevice)
{
}

CRightLeg::CRightLeg(LPDIRECT3DDEVICE9 pDevice, UNITTYPE eUnitType)
: CCubeObject(pDevice)
...
HRESULT CRightLeg::Invalidate(void)
{
...
HRESULT CRightLeg::AddComponent(void)
{
...
void CRightLeg::Release(void)
{

}

CRightLeg* CRightLeg::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CRightLeg* pRightLeg = new CRightLeg(pDevice);

	if(FAILED(pRightLeg->Invalidate()))
		ENGINE::Safe_Delete(pRightLeg);

	return pRightLeg;
}

CRightLeg* CRightLeg::Create(LPDIRECT3DDEVICE9 pDevice, UNITTYPE m_eUnitType)
{
	CRightLeg* pRightLeg = new CRightLeg(pDevice, m_eUnitType);
