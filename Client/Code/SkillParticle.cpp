...
CSkillParticle::CSkillParticle(LPDIRECT3DDEVICE9 pDevice)
...
CSkillParticle* CSkillParticle::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CSkillParticle*		pSkillParticle = new CSkillParticle(pDevice);
...
void CSkillParticle::SetColor(float fColorRed, float fColorGreen, float fColorBlue, float fColorAlpha)
{	
...
void CSkillParticle::SetTarget(ENGINE::CComponent* _Target)
{
	m_pTargetInfo = _Target;
}

void CSkillParticle::SetPos(D3DXVECTOR3 _vTargetPos)
{
	m_vTargetPos = _vTargetPos;
}

HRESULT CSkillParticle::Initialize(void)
{
	m_PrtN	= 5;
...
void CSkillParticle::Update(void)
{
	if(!m_bAni)
		return;
	...
	*/
	...
	{	
		...
		pPrt->CrnP.x = m_vTargetPos.x;
		pPrt->CrnP.y = m_vTargetPos.y;
		pPrt->CrnP.z = m_vTargetPos.z;
...
void CSkillParticle::Render(void)
{
	if(!m_bAni)
		return;
...
D3DXMATRIX* CSkillParticle::GetWorldMatrix(void)
{
	return NULL;
}

D3DXMATRIX* CSkillParticle::GetViewMatrix(void)
{
	return NULL;
}

D3DXMATRIX* CSkillParticle::GetProjMatrix(void)
{
	return NULL;
}

LPDIRECT3DDEVICE9* CSkillParticle::GetDevice(void)
{
	return NULL;
}

void CSkillParticle::SetAni(BOOL bAni/*=TRUE*/)
{
	m_bAni = bAni;
...
void CSkillParticle::SetAvgTime(FLOAT fTime)
{
	m_fTimeAvg = fTime;
}

void CSkillParticle::Release(void)
{

}

void CSkillParticle::SetPart(int nIdx)
{
	...
	pPrt->dColor	=	D3DXCOLOR(m_fColorRed, m_fColorGreen, m_fColorBlue, m_fColorAlpha);//pPrt->fLife);
...
void CSkillParticle::SetSize(float fSizeW, float fSizeH)
{
	m_fSizeW = fSizeW;
	m_fSizeH = fSizeH;
}
